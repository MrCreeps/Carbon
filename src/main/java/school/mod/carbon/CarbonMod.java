...
import school.mod.carbon.init.CarbonModEntities;
...
public class CarbonMod {
	public static final Logger LOGGER = LogManager.getLogger(CarbonMod.class);
	...
	public CarbonMod() {
		...
		CarbonModEntities.REGISTRY.register(bus);
